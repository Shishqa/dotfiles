...
-- theme.wallpaper =  themes_path.."assets/wallpaper.png" -- Comment this to use feh
...
theme.titlebar_minimize_button_normal           = gears.color.recolor_image(
  themes_path .. "assets/titlebar/minimize_1.png", theme.bg_alt)
...
theme.taglist_shape_border_color_focus = theme.black

theme.wibar_border_width = dpi(2)
theme.wibar_border_normal = theme.bg
